...
class _CreateEntryDialogState extends State<CreateEntryDialog> {
  ...
  String? _startTime;
  String? _endTime;
  Color _selectedColor = const Color(0xFF0D47A1);
  ...
  Future<void> _createEntry() async {
    ...
    setState(() {
      _isCreating = true;
      _message = "Creating entry, please wait...";
    ...
    try {
      ...
      _setMessage('Entry created successfully!', AppColors.teal);
      ...
      _setMessage('Failed to create entry: $e', Colors.redAccent);
    } finally {
      if (mounted) {
        ...
        Row(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: _isCreating ? null : _createEntry,
              child: _isCreating
                  ? const SizedBox(
                      width: 20,
                      height: 20,

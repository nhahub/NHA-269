...
class _EditTaskDialogState extends State<EditTaskDialog> {
  ...
  void initState() {
    ...
    _selectedDueDate = widget.currentDueDate;
    _selectedPriority =
        widget.currentPriority.substring(0, 1).toUpperCase() +
        widget.currentPriority.substring(1);
  }
  ...
  Future<void> _updateTask() async {
    ...
    setState(() {
      _isUpdating = true;
      _message = "Updating task, please wait...";
    ...
    try {
      ...
      _setMessage('Task updated successfully!', AppColors.teal);
      ...
      _setMessage('Failed to update task: $e', Colors.redAccent);
    } finally {
      if (mounted) {
